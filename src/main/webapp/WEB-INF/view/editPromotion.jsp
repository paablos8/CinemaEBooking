...
<div class="registration1">
    ...
    <form:form method="POST" modelAttribute="editPromotionForm">
        ...
        <form:input type="text" class="form-control" id="startDate" path="startDate" placeholder="${startDate}" />
        <label class="form-label" for="form2Example1">Start Date</label> 

        <form:input type="text" class="form-control" id="expirationDate" path="expirationDate" placeholder="${expirationDate}" />
